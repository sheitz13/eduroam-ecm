...
Messages.enter_import_password = "entrez votre mot de passe " \
    "d'importation"
Messages.credentials_prompt = "Veuillez saisir vos identifiants :"
...
Messages.empty_field = "l'un des champs était vide"
Messages.installation_finished = "Installation réussie"
Messages.cat_dir_exists = "Le répertoire {} existe ; certains de ses " \
...
Messages.save_wpa_conf = "Module DBus introuvable - veuillez installer " \
    "dbus-python ! La configuration de NetworkManager a échoué, mais nous " \
    "pouvons générer un fichier de configuration wpa_supplicant si vous " \
    "le souhaitez. Attention, votre mot de passe de connexion sera " \
    "enregistré dans ce fichier en texte clair."
Messages.save_wpa_confirm = "Écrire le fichier"
Messages.wrong_username_format = "Erreur : votre nom d'utilisateur " \
    "doit être de la forme 'xxx@institutionID', par exemple  " \
    "'john@example.net' !"
...
Messages.user_cert_missing = "fichier de certificat personnel non " \
    "trouvé"
Messages.wired = "Configure eduroam also on the wired Ethernet?\n\n " \
    "Please be aware that doing so will introduce a connection delay " \
    "lasting up to 30 sec. when you connect to an open wired network."
Config.instname = "Ecole Centrale Méditerranée"
Config.profilename = "eduroam"
Config.url = "https://dsi.centrale-med.fr/fr/search/node?keys=eduroam"
Config.email = "votre support local eduroam®"
Config.title = "eduroam CAT"
Config.server_match = "radius.centrale-marseille.fr"
...
Config.user_realm = "centrale-med.fr"
Config.ssids = ['eduroam']
Config.del_ssids = ['ECM']
Config.servers = ['DNS:radius.centrale-marseille.fr']
Config.servers_cn = 'radius.centrale-marseille.fr'
Config.use_other_tls_id = False
Config.anonymous_identity = "anonymous@centrale-med.fr"
Config.hint_user_input = True
Config.verify_user_realm_input = True
Config.tou = ""
Config.wired = ""
Config.CA = """-----BEGIN CERTIFICATE-----

-----END CERTIFICATE-----
-----BEGIN CERTIFICATE-----

JQ6ZlOj2yxNohJtFf4YASg8rw+g8DZrv6uXq
-----END CERTIFICATE-----
"""
